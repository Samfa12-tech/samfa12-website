var PocketAudioCore = (() => {
  ...
  __export(browser_exports, {
    CHIP_AUDIO_PROFILE_ID: () => CHIP_AUDIO_PROFILE_ID,
    CHIP_BASS_TONES: () => CHIP_BASS_TONES,
    CHIP_BASS_TONE_CONFIGS: () => CHIP_BASS_TONE_CONFIGS,
    CHIP_CHORD_INSTRUMENTS: () => CHIP_CHORD_INSTRUMENTS,
    CHIP_CHORD_INSTRUMENT_CONFIGS: () => CHIP_CHORD_INSTRUMENT_CONFIGS,
    CHIP_DRUM_GROOVE_PRESETS: () => CHIP_DRUM_GROOVE_PRESETS,
    CHIP_DRUM_KITS: () => CHIP_DRUM_KITS,
    CHIP_DRUM_KIT_CONFIGS: () => CHIP_DRUM_KIT_CONFIGS,
    CHIP_LEAD_INSTRUMENT_CONFIGS: () => CHIP_LEAD_INSTRUMENT_CONFIGS,
    CHIP_MELODY_INSTRUMENTS: () => CHIP_MELODY_INSTRUMENTS,
    CHIP_STYLE_PRESETS: () => CHIP_STYLE_PRESETS,
    CHIP_STYLE_PRESET_IDS: () => CHIP_STYLE_PRESET_IDS,
    CHORDSMITH_CHORD_PLAY_MODES: () => CHORDSMITH_CHORD_PLAY_MODES,
    CHORDSMITH_CHORD_RHYTHM: () => CHORDSMITH_CHORD_RHYTHM,
    CHORDSMITH_CHORD_RHYTHM_MODES: () => CHORDSMITH_CHORD_RHYTHM_MODES,
    CHORDSMITH_DRUM_FEEL: () => CHORDSMITH_DRUM_FEEL,
    CHORDSMITH_FX_GRAPH: () => CHORDSMITH_FX_GRAPH,
    CHORDSMITH_GUITAR_GATE_SECONDS: () => CHORDSMITH_GUITAR_GATE_SECONDS,
    CHORDSMITH_HUMANIZE_PEAK_BASE: () => CHORDSMITH_HUMANIZE_PEAK_BASE,
    CHORDSMITH_HUMANIZE_PEAK_RANGE: () => CHORDSMITH_HUMANIZE_PEAK_RANGE,
    CHORDSMITH_HUMANIZE_TIMING_SECONDS: () => CHORDSMITH_HUMANIZE_TIMING_SECONDS,
    CHORDSMITH_HUMANIZE_VELOCITY_BASE: () => CHORDSMITH_HUMANIZE_VELOCITY_BASE,
    CHORDSMITH_HUMANIZE_VELOCITY_RANGE: () => CHORDSMITH_HUMANIZE_VELOCITY_RANGE,
    CHORDSMITH_LIVE_DRUM_VOICES: () => CHORDSMITH_LIVE_DRUM_VOICES,
    CHORDSMITH_LOFI_TEXTURE_LIVE: () => CHORDSMITH_LOFI_TEXTURE_LIVE,
    CHORDSMITH_LOFI_TEXTURE_OFFLINE: () => CHORDSMITH_LOFI_TEXTURE_OFFLINE,
    CHORDSMITH_OFFLINE_RENDER_HEADROOM: () => CHORDSMITH_OFFLINE_RENDER_HEADROOM,
    CHORDSMITH_OFFLINE_STEM_GAIN: () => CHORDSMITH_OFFLINE_STEM_GAIN,
    CHORDSMITH_PHRASE_GATES: () => CHORDSMITH_PHRASE_GATES,
    CHORDSMITH_PITCHED_TUPLET: () => CHORDSMITH_PITCHED_TUPLET,
    CHORDSMITH_SEQUENCED_DRUM_LANE_IDS: () => CHORDSMITH_SEQUENCED_DRUM_LANE_IDS,
    CHORDSMITH_SIDECHAIN_ATTACK_SECONDS: () => CHORDSMITH_SIDECHAIN_ATTACK_SECONDS,
    CHORDSMITH_SIDECHAIN_DEPTH: () => CHORDSMITH_SIDECHAIN_DEPTH,
    CHORDSMITH_SIDECHAIN_FLOOR: () => CHORDSMITH_SIDECHAIN_FLOOR,
    CHORDSMITH_SIDECHAIN_RELEASE_SECONDS: () => CHORDSMITH_SIDECHAIN_RELEASE_SECONDS,
    CLASSIC_BASS_TONE_CONFIG: () => CLASSIC_BASS_TONE_CONFIG,
    CLASSIC_CHORD_INSTRUMENT_CONFIGS: () => CLASSIC_CHORD_INSTRUMENT_CONFIGS,
    CLASSIC_DRUM_KIT_CONFIG: () => CLASSIC_DRUM_KIT_CONFIG,
    CLASSIC_LEAD_INSTRUMENT_CONFIGS: () => CLASSIC_LEAD_INSTRUMENT_CONFIGS,
    CORE_PROJECT_VERSION: () => CORE_PROJECT_VERSION,
    DEFAULT_BPM: () => DEFAULT_BPM,
    DEFAULT_CHIP_DRUM_KIT: () => DEFAULT_CHIP_DRUM_KIT,
    DEFAULT_CHIP_PRESET_ID: () => DEFAULT_CHIP_PRESET_ID,
    DEFAULT_CHIP_TEXTURE: () => DEFAULT_CHIP_TEXTURE,
    DEFAULT_CHORD_INSTRUMENT: () => DEFAULT_CHORD_INSTRUMENT,
    DEFAULT_CLASSIC_BASS_TONE: () => DEFAULT_CLASSIC_BASS_TONE,
    DEFAULT_CLASSIC_DRUM_KIT: () => DEFAULT_CLASSIC_DRUM_KIT,
    DEFAULT_FX: () => DEFAULT_FX,
    DEFAULT_GUITAR_REGISTER: () => DEFAULT_GUITAR_REGISTER,
    DEFAULT_GUITAR_STRUM_MODE: () => DEFAULT_GUITAR_STRUM_MODE,
    DEFAULT_GUITAR_TONE: () => DEFAULT_GUITAR_TONE,
    DEFAULT_LOFI_DRUM_KIT: () => DEFAULT_LOFI_DRUM_KIT,
    DEFAULT_LOFI_PRESET_ID: () => DEFAULT_LOFI_PRESET_ID,
    DEFAULT_LOFI_TEXTURE: () => DEFAULT_LOFI_TEXTURE,
    DEFAULT_MASTER_VOLUME: () => DEFAULT_MASTER_VOLUME,
    DEFAULT_MELODY_INSTRUMENT: () => DEFAULT_MELODY_INSTRUMENT,
    DEFAULT_METAL_DRUM_KIT: () => DEFAULT_METAL_DRUM_KIT,
    DEFAULT_METAL_PRESET_ID: () => DEFAULT_METAL_PRESET_ID,
    DEFAULT_METAL_TEXTURE: () => DEFAULT_METAL_TEXTURE,
    DEFAULT_PPQ: () => DEFAULT_PPQ,
    DEFAULT_RESOLUTION: () => DEFAULT_RESOLUTION,
    DEFAULT_SOURCE_SCHEMA_VERSION: () => DEFAULT_SOURCE_SCHEMA_VERSION,
    DEFAULT_STEM_MIX: () => DEFAULT_STEM_MIX,
    DEFAULT_TIME_SIG: () => DEFAULT_TIME_SIG,
    DRUM_LANES: () => DRUM_LANES,
    DRUM_PATTERN_DEFS: () => DRUM_PATTERN_DEFS,
    DRUM_PRESETS: () => DRUM_PRESETS,
    GAME_PACK_FOLDERS: () => GAME_PACK_FOLDERS,
    GAME_PACK_MANIFEST_FILES: () => GAME_PACK_MANIFEST_FILES,
    GODOT_EXPORT_PROFILES: () => GODOT_EXPORT_PROFILES,
    GUITAR_PRESETS: () => GUITAR_PRESETS,
    GameStateController: () => GameStateController,
    HEAVY_METAL_AUDIO_PROFILE_ID: () => HEAVY_METAL_AUDIO_PROFILE_ID,
    LEGACY_CHIP_AUDIO_PROFILE_IDS: () => LEGACY_CHIP_AUDIO_PROFILE_IDS,
    LOFI_AUDIO_PROFILE_ID: () => LOFI_AUDIO_PROFILE_ID,
    LOFI_BASS_TONES: () => LOFI_BASS_TONES,
    LOFI_BASS_TONE_CONFIGS: () => LOFI_BASS_TONE_CONFIGS,
    LOFI_CHORD_INSTRUMENTS: () => LOFI_CHORD_INSTRUMENTS,
    LOFI_CHORD_INSTRUMENT_CONFIGS: () => LOFI_CHORD_INSTRUMENT_CONFIGS,
    LOFI_DRUM_GROOVE_PRESETS: () => LOFI_DRUM_GROOVE_PRESETS,
    LOFI_DRUM_KITS: () => LOFI_DRUM_KITS,
    LOFI_DRUM_KIT_CONFIGS: () => LOFI_DRUM_KIT_CONFIGS,
    LOFI_LEAD_INSTRUMENT_CONFIGS: () => LOFI_LEAD_INSTRUMENT_CONFIGS,
    LOFI_MELODY_INSTRUMENTS: () => LOFI_MELODY_INSTRUMENTS,
    LOFI_STYLE_PRESETS: () => LOFI_STYLE_PRESETS,
    LOFI_STYLE_PRESET_IDS: () => LOFI_STYLE_PRESET_IDS,
    MAX_SEQUENCE_SLOTS: () => MAX_SEQUENCE_SLOTS,
    METAL_BASS_TONES: () => METAL_BASS_TONES,
    METAL_BASS_TONE_CONFIGS: () => METAL_BASS_TONE_CONFIGS,
    METAL_CHORD_INSTRUMENTS: () => METAL_CHORD_INSTRUMENTS,
    METAL_CHORD_INSTRUMENT_CONFIGS: () => METAL_CHORD_INSTRUMENT_CONFIGS,
    METAL_DRUM_GROOVE_PRESETS: () => METAL_DRUM_GROOVE_PRESETS,
    METAL_DRUM_KITS: () => METAL_DRUM_KITS,
    METAL_DRUM_KIT_CONFIGS: () => METAL_DRUM_KIT_CONFIGS,
    METAL_LEAD_INSTRUMENT_CONFIGS: () => METAL_LEAD_INSTRUMENT_CONFIGS,
    METAL_MELODY_INSTRUMENTS: () => METAL_MELODY_INSTRUMENTS,
    METAL_STYLE_PRESETS: () => METAL_STYLE_PRESETS,
    METAL_STYLE_PRESET_IDS: () => METAL_STYLE_PRESET_IDS,
    NOTES: () => NOTES,
    PCS_SHARE_PREFIX: () => PCS_SHARE_PREFIX,
    POCKET_AUDIO_COMMON_DRUM_LANES: () => POCKET_AUDIO_COMMON_DRUM_LANES,
    POCKET_AUDIO_COMMON_DRUM_LANE_IDS: () => POCKET_AUDIO_COMMON_DRUM_LANE_IDS,
    POCKET_AUDIO_CORE_VERSION: () => POCKET_AUDIO_CORE_VERSION,
    POCKET_AUDIO_DRUM_LANE_ALIASES: () => POCKET_AUDIO_DRUM_LANE_ALIASES,
    POCKET_AUDIO_RESOURCE_LIMITS: () => POCKET_AUDIO_RESOURCE_LIMITS,
    POCKET_BASS_TONE_CONFIGS: () => POCKET_BASS_TONE_CONFIGS,
    POCKET_BUILT_IN_FX: () => POCKET_BUILT_IN_FX,
    POCKET_BUILT_IN_FX_TYPES: () => POCKET_BUILT_IN_FX_TYPES,
    POCKET_CHIP_SOUND_REGISTRY: () => POCKET_CHIP_SOUND_REGISTRY,
    POCKET_CHORD_INSTRUMENTS: () => POCKET_CHORD_INSTRUMENTS,
    POCKET_CHORD_INSTRUMENT_CONFIGS: () => POCKET_CHORD_INSTRUMENT_CONFIGS,
    POCKET_DRUM_KIT_CONFIGS: () => POCKET_DRUM_KIT_CONFIGS,
    POCKET_DRUM_LANES: () => POCKET_DRUM_LANES,
    POCKET_DRUM_LANE_IDS: () => POCKET_DRUM_LANE_IDS,
    POCKET_GUITAR_ARTICULATIONS: () => POCKET_GUITAR_ARTICULATIONS,
    POCKET_GUITAR_FILL_STYLES: () => POCKET_GUITAR_FILL_STYLES,
    POCKET_GUITAR_PATTERN_PRESETS: () => POCKET_GUITAR_PATTERN_PRESETS,
    POCKET_GUITAR_REGISTERS: () => POCKET_GUITAR_REGISTERS,
    POCKET_GUITAR_STEP_CYCLE: () => POCKET_GUITAR_STEP_CYCLE,
    POCKET_GUITAR_STRUM_MODES: () => POCKET_GUITAR_STRUM_MODES,
    POCKET_GUITAR_TONES: () => POCKET_GUITAR_TONES,
    POCKET_GUITAR_TONE_CONFIGS: () => POCKET_GUITAR_TONE_CONFIGS,
    POCKET_LEAD_INSTRUMENT_CONFIGS: () => POCKET_LEAD_INSTRUMENT_CONFIGS,
    POCKET_LOFI_SOUND_REGISTRY: () => POCKET_LOFI_SOUND_REGISTRY,
    POCKET_MELODY_INSTRUMENTS: () => POCKET_MELODY_INSTRUMENTS,
    POCKET_METAL_SOUND_REGISTRY: () => POCKET_METAL_SOUND_REGISTRY,
    POCKET_PRO_EQ_BANDS: () => POCKET_PRO_EQ_BANDS,
    POCKET_PRO_EQ_DEFAULT_PARAMETERS: () => POCKET_PRO_EQ_DEFAULT_PARAMETERS,
    POCKET_PRO_EQ_PRESETS: () => POCKET_PRO_EQ_PRESETS,
    POCKET_PRO_EQ_TYPE: () => POCKET_PRO_EQ_TYPE,
    POCKET_SOUND_REGISTRY: () => POCKET_SOUND_REGISTRY,
    PocketAudio: () => PocketAudio,
    PocketScheduler: () => PocketScheduler,
    RELEASE_PROFILES: () => RELEASE_PROFILES,
    RICH_EVENT_SCHEMA_VERSION: () => RICH_EVENT_SCHEMA_VERSION,
    SECTION_IDS: () => SECTION_IDS,
    STEM_IDS: () => STEM_IDS,
    VoiceManager: () => VoiceManager,
    analyseAudioChannels: () => analyseAudioChannels,
    analyseRenderedBuffer: () => analyseRenderedBuffer,
    analyseStemBuffers: () => analyseStemBuffers,
    applyMixPatchToStemBuffers: () => applyMixPatchToStemBuffers,
    assertPocketAudioProjectResourceLimits: () => assertPocketAudioProjectResourceLimits,
    base64UrlToUtf8: () => base64UrlToUtf8,
    beatDurationSeconds: () => beatDurationSeconds,
    buildPocketAudioTimeline: () => buildPocketAudioTimeline,
    buildPocketChordsmithShareCode: () => buildPocketChordsmithShareCode,
    buildQcReport: () => buildQcReport,
    buildSectionEvents: () => buildSectionEvents,
    buildStepTimeline: () => buildStepTimeline,
    chordIntervals: () => chordIntervals,
    chordMidiNotes: () => chordMidiNotes2,
    chordQuality: () => chordQuality,
    chordsmithAutoBassMidi: () => chordsmithAutoBassMidi,
    chordsmithBassIndexToMidi: () => chordsmithBassIndexToMidi,
    chordsmithChordForStep: () => chordsmithChordForStep,
    chordsmithChordIntervals: () => chordsmithChordIntervals,
    chordsmithChordMidiNotes: () => chordsmithChordMidiNotes,
    chordsmithChordQuality: () => chordsmithChordQuality,
    chordsmithChordRhythmStarts: () => chordsmithChordRhythmStarts,
    chordsmithDawSynthFxSlots: () => chordsmithDawSynthFxSlots,
    chordsmithDrumPeak: () => chordsmithDrumPeak,
    chordsmithDrumStepDuration: () => chordsmithDrumStepDuration,
    chordsmithDrumTupletDuration: () => chordsmithDrumTupletDuration,
    chordsmithFeatureSeed: () => chordsmithFeatureSeed,
    chordsmithFxParameters: () => chordsmithFxParameters,
    chordsmithGuitarStepDuration: () => chordsmithGuitarStepDuration,
    chordsmithHumanizeOffset: () => chordsmithHumanizeOffset,
    chordsmithHumanizePeak: () => chordsmithHumanizePeak,
    chordsmithHumanizeVelocity: () => chordsmithHumanizeVelocity,
    chordsmithLiveDrumPadPeak: () => chordsmithLiveDrumPadPeak,
    chordsmithLofiTextureLiveCrackleFrequency: () => chordsmithLofiTextureLiveCrackleFrequency,
    chordsmithLofiTextureLiveCrackleShouldTrigger: () => chordsmithLofiTextureLiveCrackleShouldTrigger,
    chordsmithLofiTextureLiveHissLowpass: () => chordsmithLofiTextureLiveHissLowpass,
    chordsmithLofiTextureOfflineCrackleWindow: () => chordsmithLofiTextureOfflineCrackleWindow,
    chordsmithLofiTextureOfflineSample: () => chordsmithLofiTextureOfflineSample,
    chordsmithMelodyIndexToMidi: () => chordsmithMelodyIndexToMidi,
    chordsmithNoteIndex: () => chordsmithNoteIndex,
    chordsmithOfflineStemOutputGain: () => chordsmithOfflineStemOutputGain,
    chordsmithOfflineStemRenderGain: () => chordsmithOfflineStemRenderGain,
    chordsmithPhraseDuration: () => chordsmithPhraseDuration,
    chordsmithPhraseInfo: () => chordsmithPhraseInfo,
    chordsmithPitchedTupletDuration: () => chordsmithPitchedTupletDuration,
    chordsmithPitchedTupletMiddleIndex: () => chordsmithPitchedTupletMiddleIndex,
    chordsmithPitchedTupletMiddleMidi: () => chordsmithPitchedTupletMiddleMidi,
    chordsmithPowerChordNotes: () => chordsmithPowerChordNotes,
    chordsmithScalePitchClasses: () => chordsmithScalePitchClasses,
    chordsmithSidechainDuckGain: () => chordsmithSidechainDuckGain,
    chordsmithStableNoiseSample: () => chordsmithStableNoiseSample,
    createAudioContext: () => createAudioContext,
    createGodotExportKit: () => createGodotExportKit,
    createGodotManifest: () => createGodotManifest,
    createMixerState: () => createMixerState,
    createSilentWavBlob: () => createSilentWavBlob,
    dbToGain: () => dbToGain,
    decodePcmWavBytes: () => decodePcmWavBytes,
    defaultPocketProEqParameters: () => defaultPocketProEqParameters,
    delaySettings: () => delaySettings,
    detectPocketChordsmithSchema: () => detectPocketChordsmithSchema,
    drumPresetEventsForProject: () => drumPresetEventsForProject,
    drumPresetLabel: () => drumPresetLabel,
    drumPresetVisibleForProject: () => drumPresetVisibleForProject,
    encodePcm16WavBlob: () => encodePcm16WavBlob,
    encodePcm16WavBytes: () => encodePcm16WavBytes,
    encodePcm24WavBlob: () => encodePcm24WavBlob,
    encodePcm24WavBytes: () => encodePcm24WavBytes,
    encodePcmWavBlob: () => encodePcmWavBlob,
    encodePcmWavBytes: () => encodePcmWavBytes,
    filterCutoffFromAmount: () => filterCutoffFromAmount,
    findDrumPreset: () => findDrumPreset,
    findGuitarPreset: () => findGuitarPreset,
    findPocketBuiltInFx: () => findPocketBuiltInFx,
    findPocketChordInstrumentConfig: () => findPocketChordInstrumentConfig,
    findPocketDrumLane: () => findPocketDrumLane,
    findPocketGuitarTone: () => findPocketGuitarTone,
    findPocketLeadInstrumentConfig: () => findPocketLeadInstrumentConfig,
    gainToDb: () => gainToDb,
    gamePackFullMixPath: () => gamePackFullMixPath,
    gamePackManifestPath: () => gamePackManifestPath,
    gamePackPath: () => gamePackPath,
    gamePackSectionLoopPath: () => gamePackSectionLoopPath,
    gamePackSourceProjectPath: () => gamePackSourceProjectPath,
    gamePackStemPath: () => gamePackStemPath,
    getChipStylePreset: () => getChipStylePreset,
    getLofiStylePreset: () => getLofiStylePreset,
    getMetalStylePreset: () => getMetalStylePreset,
    getPocketProEqPreset: () => getPocketProEqPreset,
    getReleaseProfile: () => getReleaseProfile,
    guitarPatternPresetIds: () => guitarPatternPresetIds,
    guitarPresetLabel: () => guitarPresetLabel,
    guitarPresetPatternForProject: () => guitarPresetPatternForProject,
    guitarPresetVisibleForProject: () => guitarPresetVisibleForProject,
    isChipProfile: () => isChipProfile,
    isLofiProfile: () => isLofiProfile,
    isMetalProfile: () => isMetalProfile,
    isPocketChipActive: () => isPocketChipActive,
    isPocketLofiActive: () => isPocketLofiActive,
    isPocketMetalActive: () => isPocketMetalActive,
    masterBuffer: () => masterBuffer,
    migratePocketChordsmithProject: () => migratePocketChordsmithProject,
    normaliseChipProjectSettings: () => normaliseChipProjectSettings,
    normaliseChipTexture: () => normaliseChipTexture,
    normaliseLofiProjectSettings: () => normaliseLofiProjectSettings,
    normaliseLofiTexture: () => normaliseLofiTexture,
    normaliseMetalProjectSettings: () => normaliseMetalProjectSettings,
    normaliseMetalTexture: () => normaliseMetalTexture,
    normalisePocketAudioDrumLane: () => normalisePocketAudioDrumLane,
    normalisePocketChordsmithProject: () => normalisePocketChordsmithProject,
    normalizeGuitarArticulation: () => normalizeGuitarArticulation,
    noteIndex: () => noteIndex,
    parsePocketChordsmithInput: () => parsePocketChordsmithInput,
    parsePocketChordsmithShareCode: () => parsePocketChordsmithShareCode,
    pocketAudioDrumLaneFallback: () => pocketAudioDrumLaneFallback,
    pocketLeadExtraLayers: () => pocketLeadExtraLayers,
    pocketProEqPresetParameters: () => pocketProEqPresetParameters,
    pos16ToStep: () => pos16ToStep,
    releaseSummaryCsv: () => releaseSummaryCsv,
    renderMarkdownReport: () => renderMarkdownReport,
    renderPocketAudioBuffer: () => renderPocketAudioBuffer,
    renderPocketAudioEventBuffer: () => renderPocketAudioEventBuffer,
    ...
    resolvePocketDrumKitId: () => resolvePocketDrumKitId,
    restorePocketChordsmithSource: () => restorePocketChordsmithSource,
    resumeAudioContext: () => resumeAudioContext,
    reverbSettings: () => reverbSettings,
    safeGamePackName: () => safeGamePackName,
    scaleDegreeToMidi: () => scaleDegreeToMidi,
    scalePitchClasses: () => scalePitchClasses,
    scheduleBassEvent: () => scheduleBassEvent,
    scheduleChordEvent: () => scheduleChordEvent,
    scheduleDrumEvent: () => scheduleDrumEvent,
    scheduleGuitarEvent: () => scheduleGuitarEvent,
    scheduleMelodyEvent: () => scheduleMelodyEvent,
    setStemValue: () => setStemValue,
    shouldUsePresetEvent: () => shouldUsePresetEvent,
    sidechainDuckCurve: () => sidechainDuckCurve,
    sidechainDuckGainAt: () => sidechainDuckGainAt,
    spanDurationSeconds: () => spanDurationSeconds,
    stepDurationSeconds: () => stepDurationSeconds,
    stepsPerBar: () => stepsPerBar,
    suggestMixPatch: () => suggestMixPatch,
    tripletTimesForSpan: () => tripletTimesForSpan,
    utf8ToBase64Url: () => utf8ToBase64Url,
    validateChipSoundRegistry: () => validateChipSoundRegistry,
    validateLofiSoundRegistry: () => validateLofiSoundRegistry,
    validateMetalSoundRegistry: () => validateMetalSoundRegistry,
    validatePocketGuitarRegistry: () => validatePocketGuitarRegistry,
    validatePocketInstrumentRegistry: () => validatePocketInstrumentRegistry,
    validatePocketSoundRegistry: () => validatePocketSoundRegistry,
    visibleDrumPresetsForProject: () => visibleDrumPresetsForProject,
    visibleGuitarPresetsForProject: () => visibleGuitarPresetsForProject
  });
  ...
  function shouldUsePresetEvent(event, resolution) {
  ...
  function chordsmithDrumStepDuration({ lane = "hat", level = 1, stepDuration = 0 } = {}) {
    ...
    const ceiling = drum === "kick" ? CHORDSMITH_DRUM_FEEL.gate.kickCeiling : drum === "snare" ? CHORDSMITH_DRUM_FEEL.gate.snareCeiling : accent ? CHORDSMITH_DRUM_FEEL.gate.hatOpenCeiling : CHORDSMITH_DRUM_FEEL.gate.hatClosedCeiling;
    const stepMul = drum === "hat" && accent ? CHORDSMITH_DRUM_FEEL.gate.hatAccentStepMul : CHORDSMITH_DRUM_FEEL.gate.standardStepMul;
  ...
  function chordsmithDrumTupletDuration({ lane = "hat", level = 1, spanDuration: spanDuration2 = 0 } = {}) {
    ...
    const ceiling = drum === "hat" && Number(level) > 1 ? CHORDSMITH_DRUM_FEEL.gate.hatAccentTupletCeiling : CHORDSMITH_DRUM_FEEL.gate.tupletCeiling;
  ...
  function baseEvent(project, section, context, patch) {
    ...
    ["midi", "midiNotes", "instrument", "articulation", "sourceArticulation", "pan", "slideMidi", "slideOffset", "direction", "drumKit", "bassTone", "sound", "lane", "role", "expression", "technique", "note", "notes", "sourceDuration", "trackId", "compatibility"].forEach((key) => {
      if (patch[key] !== void 0) event[key] = patch[key];
    });
    if (project.lofi?.texture?.enabled) event.lofiTexture = cloneJson3(project.lofi.texture);
    if (project.chip?.texture?.enabled) event.chipTexture = cloneJson3(project.chip.texture);
    if (project.metal?.texture?.enabled) event.metalTexture = cloneJson3(project.metal.texture);
    return event;
  }
  ...
  function renderPocketAudioEventBuffer(events, options = {}) {
    ...
    const durationSeconds = Number.isFinite(options.durationSeconds) ? Math.max(0, Number(options.durationSeconds)) : events.reduce((duration, event) => Math.max(duration, Number(event.time || 0) + Number(event.duration || 0)), 0);
  ...
  function renderEventToChannels(event, left, right, sampleRate) {
    ...
    const gain2 = Math.min(0.9, Math.max(0, Number(event.velocity || 0.5))) * stemScale(event.stem) * ghostScale;
  ...
  function guitarVoice(event) {
    ...
    if (event.audioProfile === "heavy_metal") {
      ...
      const palmMute = clamp014(technique.palmMute ?? (event.articulation === "palm_mute" || event.articulation === "chug" ? texture.palmMute : texture.palmMute * 0.3));
      return {
        type: "metal-guitar",
        stereo: true,
  ...
  function drumKitConfig(event) {
    const kit2 = resolvePocketDrumKitId(event.drumKit, event.audioProfile, event.metalPreset || event.funkPreset || event.westernPreset || event.chipPreset || event.lofiPreset);
  ...
  async function renderPocketAudioStems(project, options = {}) {
    ...
    stems.forEach((stem) => {
      ...
      timeline.events.filter((event) => event.stem === stem).forEach((event) => {
        ...
        const gain2 = Math.min(0.4, Math.max(0, event.velocity || 0.25)) * 0.16;
  ...
  function scheduleSimpleAudioEvent(context, event, project, targetAudioTime) {
    ...
    gain2.gain.exponentialRampToValueAtTime(1e-4, start + Math.max(0.04, (event.duration || 0.08) * voice.durationScale));
  ...
  function simpleVoiceRecipe(event) {
    ...
    if (event.type === "melody") {
      ...
      return {
        ...
        pulseDuty: chip && String(chip.channel || "pulse1").startsWith("pulse") ? Math.max(0.08, Math.min(0.92, Number(chip.duty ?? event.soundProfile?.parameters?.pulseWidth ?? 0.5))) : void 0,
    ...
    if (event.type === "kick" || event.type === "snare" || event.type === "hat") {
      const kit2 = POCKET_DRUM_KIT_CONFIGS[resolvePocketDrumKitId(event.drumKit, event.audioProfile, event.metalPreset || event.chipPreset || event.lofiPreset)] || POCKET_DRUM_KIT_CONFIGS.classic;
      const drum = event.type === "kick" ? kit2.kick : event.type === "snare" ? kit2.snare : kit2.hat;
      return {
  ...
  function scheduleMetalGuitarAudioEvent(context, event, project, start) {
    ...
    const technique = event.technique?.metal || {};
    const palmMute = clamp4(technique.palmMute ?? (event.articulation === "palm_mute" || event.articulation === "chug" ? texture.palmMute : Number(texture.palmMute || 0) * 0.3), 0, 1);
  ...
  function createManifestEvent(event) {
    ...
    [
      ...
      if (event[key] !== void 0) out[key] = cloneJson5(event[key]);
    });
    if (event.lofiTexture?.enabled) out.lofiTexture = cloneJson5(event.lofiTexture);
    if (event.chipTexture?.enabled) out.chipTexture = cloneJson5(event.chipTexture);
    if (event.metalTexture?.enabled) out.metalTexture = cloneJson5(event.metalTexture);
    return out;
  }
